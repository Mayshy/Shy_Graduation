...
<script src="../../assets/js/ie-emulation-modes-warning.js"></script><style></style>
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="apply_act.php?Student_ID=<?php echo $_SESSION["ID"] ?>">社团活动申请</a></li>
            <li><a href=""></a></li>
            <li><a href=""></a></li>
            <li><a href=""></a></li>
          </ul>
    ...
    <?php
                    ...
                    echo "为".$row["Association_Name"]."申请活动";                         
                                  
               ?></h2>
         <div class="container">
              <form class="form-horizontal" action="load_apply_act.php?Student_ID=<?php echo $_SESSION["ID"] ?>" method="POST"> 
             <div class="form-group" >       
             <label for="exampleInputName" class="sr-only">申请社团活动</label>
                 <input type="text" name="Association_Action_Content"  class="form-control"  style="width:300px;height:200px"  required="" autofocus="">
         </div>
         ...
         <h2 class="sub-header">活动申请规则</h2>
               <div class="table-responsive">
                 <table class="table table-striped">
                   
                   <tbody>
                     <tr></tr><td>1.活动须符合法律法规</td></tr>
                     <tr></tr><td>2.活动须至少提前一周申请,每周至多一次</td></tr>
                     <tr></tr><td>3.注意安全！</td></tr>
