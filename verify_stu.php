...
<script src="../../assets/js/ie-emulation-modes-warning.js"></script><style></style>
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="verify_stu.php?Student_ID=<?php echo $_SESSION["ID"] ?>">成员审核</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         ...
         <div class="container">
              <form class="form-inline" action="load_verify_stu.php?Student_ID=<?php echo $_SESSION["ID"] ?>" method="POST"> 
             <div class="input-group">       
             <label for="exampleInputName" class="sr-only">学号</label>
                 <input type="text" name="Student_ID" id="inputEmail" class="form-control" placeholder="学号" required="" autofocus="">
         </div>
         <label  >
                <input  type="radio" name="Permission" id="optionsRadios1" value="Common_User" checked>
                通过 </label>      
              <label  >
                <input  type="radio" name="Permission" id="optionsRadios2" value="Visitor">
                拒绝</label>
         <div class="input-group">
                 ...
                 <table class="table table-striped">
                   ...
                   <tbody>
                     <?php
                          ...
                          WHERE Permission='Waiting' and Association_Name != '无社团' 
                          ORDER BY Student_ID ";
                          $result = $conn->query($sql);
                          while($row = $result->fetch_assoc()) {
                             echo "<tr><td>".$row["Student_ID"]."</td><td>".$row["Name"]."</td><td>".$row["Sex"]."</td><td>".$row["Association_Name"]."</td></tr>";                        
                         }
