...
<script src="../../assets/js/ie-emulation-modes-warning.js"></script><style></style>
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="apply_asso.php?Student_ID=<?php echo $_SESSION["ID"] ?>">社团申请</a></li>
    ...
    <div class="container">
         <form class="form-inline" action="load_apply_stu.php?Student_ID=<?php echo $_SESSION["ID"] ?>" method="POST"> 
        <div class="input-group">       
        <label for="exampleInputName" class="sr-only">申请社团</label>
            <input type="text" name="Association_Name" id="inputEmail" class="form-control" placeholder="输入想申请的社团名" required="" autofocus="">
    </div>
    
        <div class="input-group">
            <button class="btn  btn-primary btn-block" type="submit" name="submit">申请</button> 
        </div>
        </form>
    </div>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php
                     ...
                     $sql = "SELECT * FROM associations order by Association_ID limit 1,1000 ";
                     $result = $conn->query($sql);
                     while($row = $result->fetch_assoc()) {
                        echo "<td>".$row["Association_Name"]."</td><td>".$row["Association_Introduction"]."</td></tr>";                        
                    }
